...
{
    public class ErrorNode : XzaarAstNode
    {
        public XzaarSyntaxNode Token { get; set; }

        public ErrorNode(object value, int nodeIndex)
            : base(XzaarAstNodeTypes.ERROR, "ERROR", value, nodeIndex)
        {
        }

        public ErrorNode(object value, XzaarSyntaxNode token, int nodeIndex)
            : base(XzaarAstNodeTypes.ERROR, "ERROR", value, nodeIndex)
        {
            Token = token;
        }
    ...
    public abstract class XzaarAstNode
    {
        ...
        public static ErrorNode Error(string message, XzaarSyntaxNode token)
        {
        ...
        public static CreateStructNode CreateStruct(StructNode str, XzaarAstNode[] structFieldInitializers)
        {
        ...
        public static LogicalNotNode Negate(XzaarAstNode expression)
        {
        ...
        public static XzaarAstNode PostfixUnary(XzaarSyntaxNode opToken, XzaarAstNode operand, XzaarSyntaxKind type)
        {
            return new UnaryNode(true, opToken.StringValue, operand, _nodeIndex++) { IsTransformed = true };
        }
        #endregion
        ...
        public void SetChildren(IEnumerable<XzaarAstNode> newChildren)
        {
            this.children.Clear();
