...
{
    public class XzaarCollectionStream<T>
    {
        ...
        /// <summary>
        /// Creates a new instance of <see cref="XzaarCollectionStream{T}"/>
        /// </summary>
        /// <param name="items"></param>
        public XzaarCollectionStream(IList<T> items)
        {
            this.items = items;
        }
        ...
        {
            get { return items.Count - this.currentIndex; }
        }
