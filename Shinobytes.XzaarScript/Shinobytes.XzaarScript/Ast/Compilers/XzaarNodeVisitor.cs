...
namespace Shinobytes.XzaarScript.Ast.Compilers
{
    ...
    public abstract class XzaarNodeVisitor : IXzaarNodeVisitor
    {
        ...
        public virtual XzaarExpression Visit(FunctionCallNode call)
        {
            ...
            if (f.NodeType == XzaarAstNodeTypes.FUNCTION)
            {
            ...
            else if (f.NodeType == XzaarAstNodeTypes.LITERAL || f.NodeType == XzaarAstNodeTypes.ACCESSOR_CHAIN)
            {
                var functionName = "";
                if (f.NodeType == XzaarAstNodeTypes.ACCESSOR_CHAIN)
                {
        ...
        private void DiscoverStructsAndFunctions(EntryNode node)
        {
            ...
            if (node.Body.NodeType == XzaarAstNodeTypes.BLOCK)
        ...
        public virtual XzaarExpression Visit(XzaarAstNode node)
        {
