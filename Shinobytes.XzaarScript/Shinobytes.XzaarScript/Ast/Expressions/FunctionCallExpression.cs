...
namespace Shinobytes.XzaarScript.Ast.Expressions
{
    public class FunctionCallExpression : XzaarExpression, IArgumentProvider
    {
        ...
        internal FunctionCallExpression(XzaarMethodInfo method, IList<XzaarExpression> args = null)
        {
    ...
    internal class InstanceFunctionCallExpressionN : FunctionCallExpression, IArgumentProvider
    {
        ...
        public InstanceFunctionCallExpressionN(XzaarMethodInfo method, XzaarExpression instance, IList<XzaarExpression> args)
            : base(method)
        {
            _instance = instance;
            _arguments = args;
    ...
    public partial class XzaarExpression
    {
        ...
        public static FunctionCallExpression Call(XzaarMethodInfo method, params XzaarExpression[] arguments)
        {
            return Call(null, method, arguments);
        }

        public static FunctionCallExpression Call(XzaarMethodInfo method, IEnumerable<XzaarExpression> arguments)
        {
            return Call(null, method, arguments);
        }

        public static FunctionCallExpression Call(XzaarExpression instance, XzaarMethodInfo method)
        {
            return Call(instance, method, EmptyReadOnlyCollection<XzaarExpression>.Instance);
        }

        public static FunctionCallExpression Call(XzaarExpression instance, XzaarMethodInfo method, params XzaarExpression[] arguments)
        {
            return Call(instance, method, (IEnumerable<XzaarExpression>)arguments);
        }

        public static FunctionCallExpression Call(XzaarExpression instance, XzaarMethodInfo method, XzaarExpression arg0, XzaarExpression arg1)
        {
            if (method == null) throw new ArgumentNullException(nameof(method));
        ...
        private static FunctionCallExpression Call(XzaarExpression instance, XzaarMethodInfo method, XzaarExpression arg0, XzaarExpression arg1, XzaarExpression arg2)
        {
            if (method == null) throw new ArgumentNullException(nameof(method));
            if (arg0 == null) throw new ArgumentNullException(nameof(arg0));
            if (arg1 == null) throw new ArgumentNullException(nameof(arg1));
        ...
        public static FunctionCallExpression Call(XzaarExpression instance, XzaarMethodInfo method, IEnumerable<XzaarExpression> arguments)
        {
            if (method == null) throw new ArgumentNullException(nameof(method));
