...
{
    public class XzaarRuntimeVariable
    {
        public string Name;
        ...
        public void InsertToArrray(object arrayIndex, object value)
        {
            ...
            if (index < 0 || index >= tmp.Count)
                throw new XzaarRuntimeException("The value '" + arrayIndex + "' is not a valid element index.");
        ...
        public XzaarRuntimeVariable(XzaarRuntime rt, VariableReference v)
            : this(rt, v, null)
        {
        }

        public XzaarRuntimeVariable(XzaarRuntime rt, ParameterDefinition p)
            : this(rt, p, null)
        {
        }

        public XzaarRuntimeVariable(XzaarRuntime rt, VariableReference v, object value)
        {
            this.Runtime = rt;
            this.Name = v.Name;
            this.Type = v.Type;
        ...
        public XzaarRuntimeVariable(XzaarRuntime rt, ParameterDefinition p, object value)
        {
            this.Runtime = rt;
            this.Name = p.Name;
            this.Type = p.Type;
        ...
        private object GetValueFromObject(object item)
        {
            ...
            var vrr = item as XzaarRuntimeVariable;
