...
namespace Shinobytes.XzaarScript.Compiler
{
    ...
    public class ScriptCompilerContext
    {
        ...
        private AnalyzedTree analyzedTree;
        ...
        public ScriptCompilerContext(string assemblyName, AnalyzedTree analyzedTree)
        {
        ...
        public AnalyzedTree AnalyzedTree => analyzedTree;
