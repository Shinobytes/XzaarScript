...
namespace Shinobytes.XzaarScript
{
    ...
    public abstract class XzaarTypeInfo : XzaarType
    {
        ...
        //public virtual XzaarPropertyInfo GetDeclaredProperty(string name)
        //{
        ...
        //public virtual IEnumerable<XzaarPropertyInfo> GetDeclareProperties(string name)
        //{
        //    foreach (XzaarPropertyInfo property in GetProperties())
        //    {
