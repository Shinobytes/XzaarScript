...
namespace Shinobytes.XzaarScript
{
    internal class XzaarTypeBuilder : XzaarType
    {
        ...
        // private readonly List<XzaarPropertyInfo> properties = new List<XzaarPropertyInfo>();
        private readonly List<XzaarFieldInfo> fields = new List<XzaarFieldInfo>();

        private bool _isArray;
        private XzaarType _arrayElementType;
        ...
        //public void AddProperty(XzaarPropertyInfo item)
        //{
        ...
        //public override XzaarPropertyInfo[] GetProperties()
        //{
        ...
        //public override XzaarPropertyInfo GetProperty(string name)
        //{
