...
namespace Shinobytes.XzaarScript.Scripting
{
    public class XzaarScriptLexer
    {
        public IReadOnlyList<XzaarSyntaxToken> Tokenize(string expression)
        {
            ...
            var badNameChars = "(){}[]%*-+<>=/ \t!½§^¨~,;.§".ToCharArray();
            var current = 0;
            var tokens = new List<XzaarSyntaxToken>();
            ...
            while (current < expression.Length)
            {
                    ...
                    case '"':
                        {
                            ...
                            tokens.Add(new XzaarSyntaxToken(XzaarNodeTypes.LITERAL, "STRING", value));
                        }
                        continue;
                    case '0':
                    case '1':
                    ...
                    case '9':
                        {
                            ...
                            current++;
                            tokens.Add(new XzaarSyntaxToken(XzaarNodeTypes.LITERAL, "NUMBER", value));
                            unaryOperator = "";
                        }
                        continue;
                    case '\t':
                ...
                throw new Exception($"Invalid token type: {symbol}");
