...
namespace Shinobytes.XzaarScript.UnitTests
{
    ...
    public class XzaarScript_Compiler_Tests
    {
        ...
        {
            var assembly = GetAssemblyForCode("fn main() { }");
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("fn looper() { return -1 let j = 0 for(let i = 0; i < 10; i++) { j++ break } return j } let result = looper()");
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("let j fn main() { j = 0 return }");
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("fn main() { return 0 }");
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("let j = 1 + 1");
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("fn main() { if(0 == 1) { let b = 0 } }");
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("fn main() { if(0 == 1) { let b = 0 } else if(1 == 4) { let z = 9999 } }");
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("fn a() { } fn b() { a() } b()");
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("fn num() { return 0 } fn main() { return num() }");
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("fn main() { let x = 0 switch(x) { case 0: return case 1: break } }");
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("fn a() { let j = 0 loop { ++j } }");
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("fn a() { let j = 0 loop { j*=2 j/=1 } }");
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("struct s { number c } fn a() { let x = s }");
            Assert.AreEqual(@".structs
  .struct s
    .flags 0
    .fields
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("struct structA { number structAField } struct structB { structA structBField } fn main() { let s1 = structB }");
            Assert.AreEqual(@".structs
  .struct structA
    .flags 0
    .fields
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("fn greet(string name) { let j = 0 switch(name) { case \"zerratar\": return true } return false }");
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("struct structA { number structAField } struct structB { structA structBField } fn main() { let s1 = structB let j1 = s1.structBField.structAField }");
            Assert.AreEqual(@".structs
  .struct structA
    .flags 0
    .fields
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("struct structA { number structAField } struct structB { structA structBField } struct structC { structB structCField } fn main() { let s1 = structC let j1 = s1.structCField.structBField.structAField }");
            Assert.AreEqual(@".structs
  .struct structA
    .flags 0
    .fields
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("struct structA { number structAField } struct structB { structA structBField } struct structC { structB structCField } fn main() { let s1 = structC s1.structCField.structBField.structAField = 9999 }");
            Assert.AreEqual(@".structs
  .struct structA
    .flags 0
    .fields
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("struct structA { number[] structAField } struct structB { structA structBField } struct structC { structB structCField } fn main() { let s1 = structC s1.structCField.structBField.structAField[0] = 9999 }");
            Assert.AreEqual(@".structs
  .struct structA
    .flags 0
    .fields
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("struct s { number c } fn a() { let x = s x.c = 0 }");
            Assert.AreEqual(@".structs
  .struct s
    .flags 0
    .fields
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("struct s { number c } fn a() { let x = s let p = x.c }");
            Assert.AreEqual(@".structs
  .struct s
    .flags 0
    .fields
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("struct s { number c } fn a() { let x = s let p = 0 p = x.c }");
            Assert.AreEqual(@".structs
  .struct s
    .flags 0
    .fields
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("fn a() { for(let i = 0; i < 100; ++i) { } }");
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("fn b() { } fn a() { for(let i = 0; i < 100; i++) { b() } }");
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("fn b() { } fn a() { for(let i = 0; i < 100; ++i) { for(let k = 0; k < 1; ++k) { b() } } }");
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("let j fn main() { while(true) { j++ }}");
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("let j fn main() { do { ++j } while(true) }");
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("fn main() { let j = 0 do { ++j loop { --j break } } while(true) }");
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("let j fn main() { let p = [] foreach(let j in p) {  } }");
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("fn main() { hello_world: goto hello_world }");
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("fn main() { loop { continue } }");
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("fn main() { loop { break } }");
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("fn main() { loop { return 0 } return 1 }");
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("fn test(any s) -> string { s.TestMethod() return s.Test } ");
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("fn main() { let a = [] a[0] = 1 }");
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("fn main() { let a = 0 loop { continue a = 1 loop { break a = 2 loop { return } } } }"); // 
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("fn do_stuff(number val) { let result = val++ return result }");
            Assert.AreEqual(
@".structs
.endStructs
.types
...
", assembly);
        ...
        public void Invoke_push_to_array_and_get_length()
        {
            ...
            //return;
            var assembly = GetAssemblyForCode("let array = [] array.push(10) let result = array.length");
            Assert.AreEqual(
            @".structs
.endStructs
.types
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("fn do_stuff(number val) { return val++ }");
            Assert.AreEqual(
@".structs
.endStructs
.types
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("fn test(any s) -> string { s.Test = \"HEHEHE\" return s.Test } ");
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("fn test(any s) -> any { return s.Result1(\"hello there\") } ");
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("struct structA { number[] hello } fn do_stuff() { let s = structA for(let i = 0; i < 5; i++) { s.hello[i] = i } return s.hello } ");
            Assert.AreEqual(@".structs
  .struct structA
    .flags 0
    .fields
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode(@"fn main(any console) -> void {
   let anders = ""Anders""
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode(
        @"let console = $0 
let zerratar = ""Karl""
fn favoColor() -> string { 
    return ""green""
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("let i = 4 % 2");
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("fn test(any s) -> string { s.Val.Test = \"HEHEHE\" return s.Val.Test } ");
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("fn looper() { let j = 0 loop { j++ if (j > 10) { break } } return j } let result = looper()");
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", assembly);
        ...
        public void Push_array_return_item_value_7()
        {
            ...
            var assembly = GetAssemblyForCode(@"let console = $console
...
", assembly);
        ...
        {
            var assembly = GetAssemblyForCode("struct testStruct { number hello } fn fun_with_struct(testStruct s) { s.hello = 9999 } fn do_stuff() { let s1 = testStruct fun_with_struct(s1) return s1.hello }");
            Assert.AreEqual(@".structs
  .struct testStruct
    .flags 0
    .fields
...
", assembly);
        ...
        {
            var code = GetAssemblyForCode(@"struct s {
    number num,
    string str
}
...
", code);
        ...
        {
            var code = GetAssemblyForCode("fn test(any console) { console.log(\"Hello World\"[0].length) }");            
            Assert.AreEqual(@".structs
.endStructs
.types
.endTypes
...
", code);
        ...
        {
            var code = GetAssemblyForCode(@"let console = $console
let names = []
...
", code);
        ...
        private string GetAssemblyForCode(string inputCode)
        {
            return Compile(inputCode).Disassemble();
        }
    }
}